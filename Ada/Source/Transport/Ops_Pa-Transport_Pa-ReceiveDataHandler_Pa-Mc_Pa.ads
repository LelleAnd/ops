...
package Ops_Pa.Transport_Pa.ReceiveDataHandler_Pa.Mc_Pa is

-- ==========================================================================
--      C l a s s    D e c l a r a t i o n.
-- ==========================================================================
  type McReceiveDataHandler_Class is new ReceiveDataHandler_Class with
      private;
  type McReceiveDataHandler_Class_At is access all McReceiveDataHandler_Class'Class;
  ...
  function Create( top : Ops_Pa.OpsObject_Pa.Topic_Pa.Topic_Class_At;
                   ...
                   Reporter : Ops_Pa.Error_Pa.ErrorService_Class_At ) return McReceiveDataHandler_Class_At;
...
-- ==========================================================================
  ...
  --------------------------------------------------------------------------
  overriding procedure Finalize( Self : in out McReceiveDataHandler_Class );

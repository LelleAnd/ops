...
The generated method can be called in user code to check if the object instance is valid. Currently validation code is only generated for Ada, C++ and Delphi, see also the [Feature List](FeatureList.md).

...
OPSListener Version 2026-04-23
  ...
  Topic names can use regex (eg. ".*zz.*" means any topic with 'zz' any where in the name).


Usage:
  OPSListener [-v] [-?] [-c ops_cfg_file [-c ops_cfg_file [...]]]
              [-a arg_file [-a arg_file [...]]]
              [-j json_file [-j json_file [...]]] [-jr rowlimit]
              [-t] [-pA | -p<option_chars>] [-d [num]]
              [-s]
              [-GA | -G domain [-G domain [...]]]
              [-IA | -I domain [-I domain [...]] [-o] [-O]]
              [-SA | -S domain [-S domain [...]]]
              [-CH channel [-CH channel [...]]]
              [-f<knSy> param [-f<knSy> param [...]]]
    ...
    -CH channel        Limit to topics on given channel(s)
    ...
    -E                 If -C or -s given, minimize normal output
    -f<knSy> param     Filter messages shown on given value (regex)
                 k       param = Key
                 n       param = Publisher Name
                 S       param = Source IP::Port
                 y       param = Type
    ...
    -jr rowlimit       Specifies the row limit for presented vectors in the Message descriptions
    -n                 Don't subscribe to topics following
    -o                 if -I or -IA given, show more detailed Topic info

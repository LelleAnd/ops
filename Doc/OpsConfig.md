...
Elements of _Channel_ contains:
  ...
  * **linktype**, configures which transport mechanism to be used for this channel. Supported values are *inprocess*, *shmem*, *multicast*, *udp* and *tcp*. If tag is omitted, *multicast* is used.
